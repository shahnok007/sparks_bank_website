...
<body style="background-color:#040338;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/shah2.png" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">Website Creator</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">SHAHNAWAZ KHAN</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Dr.AMBEDKAR INSTITUTE OF TECHNOLOGY FOR HANDICAPPED ,KANPUR,UTTAR PRADESH.</b></p>
    </center>
